...
@IBDesignable class DetailDataView: UIView {
    public static let Identifier = "DetailDataView"
    ...
    private func loadNib() {
        Bundle.main.loadNibNamed(DetailDataView.Identifier, owner: self, options: nil)
